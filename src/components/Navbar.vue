        ...
        <ul
          ...
          <li>
            <router-link
              ...
              <span class="flex-1 ml-2 whitespace-nowrap">{{ $t('home') }}</span>
            </router-link>
          </li>
          <li>
            <router-link
            ...
            <div
              ...
              <ul class="py-1" role="none">
                ...
                <li>
                  <a
                    href="#"
                    class="block px-4 mt-1 py-2s hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white"
                    role="menuitem">
                    <div class="inline-flex items-center">
                      <img
                        class="h-3.5 w-3.5 rounded-full mr-2"
